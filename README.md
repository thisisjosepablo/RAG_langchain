...
- It is needed to split the documents into chunks, then create embeddings of them and finllay to save to the database what we are using, in this case, ChromaDB.
